#!/bin/bash
#SBATCH --job-name=teacher-baoding
...
#SBATCH --output=/mnt/kostas-graid/sw/envs/edward/in-hand-rotation-results/teacher_baoding_20260613/logs/%j.out
#SBATCH --error=/mnt/kostas-graid/sw/envs/edward/in-hand-rotation-results/teacher_baoding_20260613/logs/%j.err
