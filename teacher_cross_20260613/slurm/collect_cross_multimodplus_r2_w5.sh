#!/bin/bash
#SBATCH --job-name=collect-cross-w5
...
#SBATCH --output=/mnt/kostas-graid/sw/envs/edward/in-hand-rotation-results/teacher_cross_20260613/logs/%j_collect_r2_w5.out
#SBATCH --error=/mnt/kostas-graid/sw/envs/edward/in-hand-rotation-results/teacher_cross_20260613/logs/%j_collect_r2_w5.err
...
CUDA_VISIBLE_DEVICES=0 python ./isaacgymenvs/train_distillation.py ${COMMON} distill.worker_id=5

echo "[$(date)] Worker 5 done."
