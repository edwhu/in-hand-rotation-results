#!/bin/bash
#SBATCH --job-name=collect-cross-w4
...
#SBATCH --output=/mnt/kostas-graid/sw/envs/edward/in-hand-rotation-results/teacher_cross_20260613/logs/%j_collect_r2_w4.out
#SBATCH --error=/mnt/kostas-graid/sw/envs/edward/in-hand-rotation-results/teacher_cross_20260613/logs/%j_collect_r2_w4.err
...
CUDA_VISIBLE_DEVICES=0 python ./isaacgymenvs/train_distillation.py ${COMMON} distill.worker_id=4

echo "[$(date)] Worker 4 done."
