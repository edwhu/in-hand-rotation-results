#!/bin/bash
#SBATCH --job-name=collect-cross-w3
...
#SBATCH --output=/mnt/kostas-graid/sw/envs/edward/in-hand-rotation-results/teacher_cross_20260613/logs/%j_collect_r2_w3.out
#SBATCH --error=/mnt/kostas-graid/sw/envs/edward/in-hand-rotation-results/teacher_cross_20260613/logs/%j_collect_r2_w3.err

# Per-job local tmp avoids NFS lock contention during gymtorch compilation
...
CUDA_VISIBLE_DEVICES=0 python ./isaacgymenvs/train_distillation.py ${COMMON} distill.worker_id=3

echo "[$(date)] Worker 3 done."
