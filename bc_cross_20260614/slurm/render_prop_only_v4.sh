...
#SBATCH --output=/mnt/kostas-graid/sw/envs/edward/in-hand-rotation-results/bc_cross_20260614/logs/render_prop_only_v4_%j.log
...
CUDA_VISIBLE_DEVICES=0 python ./isaacgymenvs/train_distillation.py \
  ...
  distill.video_path=/mnt/kostas-graid/sw/envs/edward/in-hand-rotation-results/bc_cross_20260614/prop_only_v4.mp4
