#!/bin/bash
#SBATCH --job-name=teacher-baoding-s2
...
#SBATCH --output=/mnt/kostas-graid/sw/envs/edward/in-hand-rotation-results/teacher_baoding_20260613_s2/logs/%j.out
#SBATCH --error=/mnt/kostas-graid/sw/envs/edward/in-hand-rotation-results/teacher_baoding_20260613_s2/logs/%j.err
...
CUDA_VISIBLE_DEVICES=0 python ./isaacgymenvs/train.py headless=True seed=2 \
  ...
  train.params.config.user_prefix=baoding-s2 wandb_activate=True \
  wandb_entity=edhu
