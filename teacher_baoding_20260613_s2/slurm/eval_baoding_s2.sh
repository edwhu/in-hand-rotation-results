#!/bin/bash
#SBATCH --job-name=eval-baoding-s2
...
#SBATCH --time=1:00:00
#SBATCH --gres=gpu:1
#SBATCH --output=/mnt/kostas-graid/sw/envs/edward/in-hand-rotation-results/teacher_baoding_20260613_s2/logs/%j_eval.out
#SBATCH --error=/mnt/kostas-graid/sw/envs/edward/in-hand-rotation-results/teacher_baoding_20260613_s2/logs/%j_eval.err
...
CKPT="runs/baoding/baoding-s2S1.0_C0.0_M0.02026-06-13_07-53-44-7412/nn/baoding.pth"
...
CUDA_VISIBLE_DEVICES=0 python ./isaacgymenvs/train.py headless=True test=True seed=2 \
  ...
  train.params.config.user_prefix=baoding-s2 \
  checkpoint="${CKPT}"
