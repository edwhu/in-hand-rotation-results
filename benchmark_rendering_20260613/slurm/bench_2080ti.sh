...
#SBATCH --time=6:00:00
#SBATCH --gres=gpu:1
#SBATCH --nodelist=dj-2080ti-0.grasp.maas
#SBATCH --output=/mnt/kostas-graid/sw/envs/edward/in-hand-rotation-results/benchmark_rendering_20260613/logs/%j_bench_2080ti.out
#SBATCH --error=/mnt/kostas-graid/sw/envs/edward/in-hand-rotation-results/benchmark_rendering_20260613/logs/%j_bench_2080ti.err
...
COMMON="headless=True task=AllegroArmMOAR task.env.objSet=cross \
  ...
  distill.teacher_data_dir=benchmark-tmp-2080ti \
  distill.teacher_logdir=runs distill.teacher_resume=wheel-wrench-teacher-s1 \
  train.params.config.user_prefix=bench-2080ti wandb_activate=False experiment=bench"
